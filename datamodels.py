...
class Torqlogs(Base):
	...
	costpermilekmtripkm = Column('costpermilekmtripkm', Double)
	...
	# o2sensor1widerangeequivalenceratio - duplicate removed
	# o2sensor1widerangevoltagev - duplicate removed
	# voltagecontrolmodulev - duplicate removed
	# volumetricefficiencycalculated - duplicate removed
